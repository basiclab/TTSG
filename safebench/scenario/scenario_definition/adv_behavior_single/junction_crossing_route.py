...
class OppositeVehicleRunningRedLight(BasicScenario):
    ...
    def __init__(self, world, ego_vehicle, config, timeout=60):
        super(OppositeVehicleRunningRedLight, self).__init__(
            "OppositeVehicleRunningRedLight-Behavior-Single", config, world
        )
    ...
    def initialize_actors(self):
        ...
        forward_vector = (
            other_actor_transform.rotation.get_forward_vector()
            * self.other_actor_delta_x
        )
        ...
        traffic_light_other = CarlaDataProvider.get_next_traffic_light(
            other_actor_transform, False, True
        )
    ...
    def create_behavior(self, scenario_init_action):
        ...
        ), f"{self.name} should receive [None] initial action."
...
class SignalizedJunctionLeftTurn(BasicScenario):
    ...
    def __init__(self, world, ego_vehicle, config, timeout=60):
        super(SignalizedJunctionLeftTurn, self).__init__(
            "SignalizedJunctionLeftTurn-Behavior-Single", config, world
        )
        self.ego_vehicle = ego_vehicle
        self.timeout = timeout
...
class SignalizedJunctionRightTurn(BasicScenario):
    ...
    def __init__(self, world, ego_vehicle, config, timeout=60):
        super(SignalizedJunctionRightTurn, self).__init__(
            "SignalizedJunctionRightTurn-Behavior-Single", config, world
        )
        self.ego_vehicle = ego_vehicle
        self.timeout = timeout
...
class NoSignalJunctionCrossingRoute(BasicScenario):
    ...
    def __init__(self, world, ego_vehicle, config, timeout=60):
        super(NoSignalJunctionCrossingRoute, self).__init__(
            "NoSignalJunctionCrossingRoute-Behavior-Single", config, world
        )
        self.ego_vehicle = ego_vehicle
        self.timeout = timeout
