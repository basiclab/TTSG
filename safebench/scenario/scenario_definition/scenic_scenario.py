...
from safebench.scenario.scenario_definition.scenic.dynamic_scenic import (
    DynamicScenic as scenario_scenic,
)
...
class ScenicScenario:
    ...
    def __init__(self, world, config, ego_id, logger, max_running_step):
        ...
        self.other_actors = []
        self.list_scenarios = [
            scenario_scenic(world, self.ego_vehicle, self.config, timeout=self.timeout)
        ]
