...
class ManeuverOppositeDirection(BasicScenario):
    ...
    def __init__(self, world, ego_vehicle, config, timeout=120):
        ...
        super(ManeuverOppositeDirection, self).__init__(
            "ManeuverOppositeDirection-AdvTraj", config, world
        )
    ...
    def initialize_actors(self):
        ...
        self.actor_transform_list = [
            ...
            second_actor_waypoint.transform,
        ]
        ...
        forward_vector = (
            self.actor_transform_list[1].rotation.get_forward_vector()
        ...
        self.other_actor_final_transform = carla.Transform(
            self.actor_transform_list[1].location, self.actor_transform_list[1].rotation
        )
    ...
    def update_behavior(self, scenario_action):
        ...
        self.scenario_operation.drive_to_target_followlane(
            1, target_transform, self._opposite_speed
        )
