...
TRIGGER_THRESHOLD = (
    2.0  # Threshold to say if a trigger position is new or repeated, works for matching positions
)
TRIGGER_ANGLE_THRESHOLD = (
    10  # Threshold to say if two angles can be considering matching when matching transforms.
)
