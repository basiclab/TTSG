...
def get_parser(scenicFile):
    parser = argparse.ArgumentParser(
        ...
        description="Sample from a Scenic scenario, optionally " "running dynamic simulations.",
    )
    ...
    mainOptions.add_argument(
        ...
        "--simulate",
        default=True,
        help="run dynamic simulations from scenes " "instead of simply showing diagrams of scenes",
    )
    ...
    mainOptions.add_argument(
        "-m",
        "--model",
        help="specify a Scenic world model",
        default="scenic.simulators.carla.model",
    )
    mainOptions.add_argument(
        "--scenario",
        default=None,
    ...
    simOpts.add_argument(
        "--time",
        help="time bound for simulations (default none)",
        type=int,
        default=10000,
    )
    simOpts.add_argument(
    ...
    debugOpts.add_argument(
        "--show-records",
        help="show values of recorded expressions",
        action="store_true",
    )
    debugOpts.add_argument(
        "-b",
    ...
    parser.add_argument(
        "--scenicFile", help="a Scenic file to run", default=scenicFile, metavar="FILE"
    )
