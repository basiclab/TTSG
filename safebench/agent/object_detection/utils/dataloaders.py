...
from safebench.agent.object_detection.utils.augmentations import (
    Albumentations,
    augment_hsv,
    copy_paste,
    letterbox,
...
from safebench.agent.object_detection.utils.torch_utils import (
...
if __name__ == "__main__":
    dataset = LoadImages("./online_data/", img_size=1024)
    cnt = 0
    for path, img, img0, cap, s in dataset:
        print(img.shape)
        print(img0.shape)
        cv2.imwrite("./online_data/images/" + str(cnt) + ".jpg", img0)
        cnt += 1
