...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, target_speed=20, opt_dict={}, map_inst=None, grp_inst=None):
        ...
        self.interfere_target = None
        self._ego_road_id = None
    ...
    def set_destination(self, end_location, start_location=None, interfere_target=None):
        """
        ...
        self.destination_waypoint = end_waypoint
        self.interfere_target = interfere_target
        if interfere_target is not None:
            ego_vehicle_loc = interfere_target._vehicle.get_location()
            ego_vehicle_wp = self._map.get_waypoint(ego_vehicle_loc)
            self._ego_road_id = ego_vehicle_wp.road_id
    ...
    def _affected_by_traffic_light(self, lights_list=None, max_distance=None):
        ...
        for traffic_light in lights_list:
            ...
            if is_within_distance(
                trigger_wp.transform, self._vehicle.get_transform(), max_distance, [0, 90]
            ):
    ...
    def _vehicle_obstacle_detected(
        ...
        opposite_invasion = (
            abs(self._offset) + self._vehicle.bounding_box.extent.y > ego_wpt.lane_width / 2
        )
