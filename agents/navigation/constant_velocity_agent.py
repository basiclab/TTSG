...
class ConstantVelocityAgent(BasicAgent):
    ...
    def __init__(self, vehicle, target_speed=20, opt_dict={}, map_inst=None, grp_inst=None):
        ...
        """
        super().__init__(
            vehicle, target_speed, opt_dict=opt_dict, map_inst=map_inst, grp_inst=grp_inst
        )
        ...
        self._restart_time = float(
            "inf"
        )  # Time after collision before the constant velocity behavior starts again
    ...
    def run_step(self):
        ...
        if affected_by_vehicle:
            ...
            if vehicle_velocity.length() == 0:
                ...
                hazard_speed = (
                    vehicle_velocity.dot(adversary.get_velocity()) / vehicle_velocity.length()
                )
